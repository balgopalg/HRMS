...
const AddSalary = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!salary.employee || !salary.basicSalary || !salary.paymentDate) {
            alert('Please provide all required fields: Employee, Basic Salary, and Payment Date.');
            return;
        }
        ...
        try {
            ...
            if (response.data.success) {
                ...
                alert('Failed to add salary record: ' + response.data.message);
            }
        } catch (error) {
    ...
    return (
        <div className="bg-gray-100 min-h-screen p-8">
            ...
            <div className="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-md border-t-4 border-teal-500">
                <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Add Salary Record</h2>
